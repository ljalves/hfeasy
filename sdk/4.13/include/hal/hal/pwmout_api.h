...
void pwmout_sync_write(pwmout_t *obj, float percent, uint8_t duty_sel);
...
//HF add
void pwmout_diff_write_ticks_hf(pwmout_t *obj, int in_ticks);
void pwmout_sync_write_ticks_hf(pwmout_t *obj, int in_ticks, uint8_t duty_sel);
void pwmout_period_ticks_hf(pwmout_t* obj, int in_ticks);
void pwmout_pulsewidth_ticks_hf(pwmout_t* obj, int in_ticks);
